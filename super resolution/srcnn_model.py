...
class SRCNN(nn.Module):
	def __init__(self):
		...
		self.conv1 = default_conv(1, 64, kernel_size = 9, padding = 9 // 2)
		self.conv2 = default_conv(64, 32, kernel_size = 1, padding = 1 // 2)
		self.conv3 = default_conv(32, 1, kernel_size = 3, padding = 3 // 2)
